...
public class ItemCan extends Item {
	...
	public static void registerRender(Item item) {
        ...
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(item, 0, new ModelResourceLocation(ModInfo.MODID + ":" + ItemInfo.ITEM_CAN_UNLOCALIZED, "inventory"));		
	}
}