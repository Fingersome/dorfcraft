...
public class ItemSaw extends Item {
	...
	public static void registerRender(Item item) {
        ...
        Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(item, 0, new ModelResourceLocation(ModInfo.MODID + ":" + ItemInfo.ITEM_SAW_UNLOCALIZED, "inventory"));
	}
}