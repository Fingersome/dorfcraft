...
public class DorfAnvilShapedRecipes implements IRecipe
{
    ...
    public DorfAnvilShapedRecipes(int width, int height, ItemStack[] p_i1917_3_, ItemStack output)
    {
    ...
    public DorfAnvilShapedRecipes func_92100_c()
    {
